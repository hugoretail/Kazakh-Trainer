const alphabetLetters = [
  { prompt: "А", answers: ["a"] },
  { prompt: "Ә", answers: ["a", "ae"] },
  { prompt: "Б", answers: ["b"] },
  { prompt: "В", answers: ["v"] },
  { prompt: "Г", answers: ["g"] },
  { prompt: "Ғ", answers: ["gh", "g"] },
  { prompt: "Д", answers: ["d"] },
  { prompt: "Е", answers: ["e", "é"] },
  { prompt: "Ё", answers: ["yo"] },
  { prompt: "Ж", answers: ["j"] },
  { prompt: "З", answers: ["z"] },
  { prompt: "И", answers: ["i"] },
  ...
  { prompt: "Х", answers: ["kh"] },
  { prompt: "Ц", answers: ["ts"] },
  { prompt: "Ч", answers: ["tch"] },
  { prompt: "Щ", answers: ["chtch"] },
  { prompt: "Ъ", answers: ["muet"] },
  { prompt: "Ы", answers: ["y"] },
  { prompt: "Ь", answers: ["muet"] },
  { prompt: "Э", answers: ["e", "é"] },
  { prompt: "Ю", answers: ["you"] },
  { prompt: "Я", answers: ["ya"] },
];
